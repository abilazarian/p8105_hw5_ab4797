...
This plot demonstrates the direct relationsip between power and effect size. As effect size increases, so does power. This makes sense conceptually as power is the likelihood that a study will detect an effect, an effect is more likely to be detected if it is larger. 
